...
def display(config):
    ...
    # Determine the index based on current MODEL_TYPE
    if config.MODEL_TYPE in output_type_options:
        output_type_index = output_type_options.index(config.MODEL_TYPE)
    else:
    ...
    config.MODEL_TYPE = selected_output_type  # Update the config instance
